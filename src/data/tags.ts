...
export const ALL_TAGS: TagDef[] = [
  ...
  // ---- Level 3 (under 知识管理) ----
  { key: "digital-garden", label: "Noösphere", level: 3, parent: "knowledge" },
  ...
  { key: "history", label: "历史", level: 3, parent: "methodology" },
  { key: "philosophy", label: "哲学", level: 3, parent: "methodology" },
